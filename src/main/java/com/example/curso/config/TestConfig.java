...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2021-10-09T18:57:45Z"), u1);
        Order o2 = new Order(null, Instant.parse("2021-11-10T03:42:45Z"), u2);
        Order o3 = new Order(null, Instant.parse("2021-11-11T15:21:25Z"), u1);
